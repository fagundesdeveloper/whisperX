...
def load_vad_model(device, vad_onset=0.500, vad_offset=0.363, use_auth_token="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", model_fp=None):
...
class VoiceActivitySegmentation(VoiceActivityDetection):
    def __init__(
        self,
        segmentation: PipelineModel = "filfagundes/speaker-segmentation-fine-tuned-pt",
        fscore: bool = False,
        use_auth_token: Union[Text, None] = "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",
        **inference_kwargs,
    ):
